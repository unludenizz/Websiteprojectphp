...
if(isset($_POST["giris"])){
    ...
    if(empty($parola1)){
        $parola_err = "Das Passwort darf nicht leer sein.";
    }
                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="giris" selectedPHP>Deutsch</option>
                            <option value="../eng/giris">Englisch</option>
                            <option value="../giris">Turkisch</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    ...
                    <strong><i class="icon_key_alt"></i><h3>Anmeldung</h3></strong>
                    <div class="form-group">
                        <input type="text" name="kullaniciadi" class=" form-control " placeholder="Nutzername">
                        <span class="input-icon"><i class="icon_pencil-edit"></i></span>
                    </div>
                    <div class="form-group" style="margin-bottom:5px;">
                        <input type="password" class="form-control" placeholder="Passwort" name="parola" style="margin-bottom:5px;">
                        <span class="input-icon"><i class="icon_lock_alt"></i></span>
                    </div>
                    <p class="small">
                        <a href="forgotpass.php">Klicken Sie hier, wenn Sie Ihr Passwort vergessen haben.</a>
                    </p>
                    <p class="small">
                        <a href="kayit.php">Klicken Sie, wenn Sie kein Mitglied sind.</a>
                    </p>
                    <button type="submit" name="giris" class="button_login">ANMELDUNG</button>
                    </form>
                </div>
            </div>
        </div>
