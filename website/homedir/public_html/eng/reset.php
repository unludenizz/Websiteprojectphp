...
WHERE email = '$email'";
    ...
    $url = "https://www.golhisarim.com.tr/eng/giris.php";
    $wait_time = 3;
    ...
    $url = "https://www.golhisarim.com.tr/eng/index.php../";
    $wait_time = 3;
    header("Refresh:$wait_time; url=$url");
}
                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="reset" selected>English</option>
                            <option value="../reset">Turkish</option>
                            <option value="../deu/reset">German</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="container margin_30">
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                     <!-- giriş -->
                    <form action=http://www.golhisarim.com.tr/reset.php?email=<?php echo $email;?>&token=<?php echo $token;?> method="POST">
                    <strong><i class="icon_key_alt"></i><h3>Password reset</h3></strong>
                    <div class="form-group">
                        <input type="text" name="sifre" class=" form-control " placeholder="New Password">
                        <span class="input-icon"><i class="icon_pencil-edit"></i></span>
                    </div>
                   
                   
                    <button type="submit" name="submit" onclick="openpopuppp()" class="button_login">CHANGE</button>
                    </form>
                </div>
            </div>
        </div>
