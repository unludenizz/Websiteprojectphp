        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav class="col--md-8 col-sm-9 col-xs-8">
                    <ul id="primary_nav">
                        <li id="login"><a href="giris.php">Giriş Yap</a>
                        </li>
                        <li id="wishlist"><a href="index.php#sektörler">Sektörler</a>
                        </li>
                        <li id="buy"><a href="#" onclick="closePopupp()">Sektörünü ekle</a>
                        </li>
                        ...
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this, '<?php echo $value; ?>')">
                            <option value="yeme-icme" selected>Türkçe</option>
                            <option value="eng/yeme-icme">İngilizce</option>
                            <option value="deu/yeme-icme">Almanca</option>
                        </select>
                        </div></li>
                    </ul>
                    ...
                    <div class="main-menu">
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <li><a href="giris.php">Sektörünü ekle</a>
                                </li>
        ...
        <div class="tools_i">
            <div class="directions_list_map" onclick="showInMap()">
                <a class="tooltip_styled tooltip-effect-4">
                    ...
                    <div class="tooltip-content">Haritada Görüntüle</div>
                </a>
            </div>
            <div class="wishlist">
                <a href="firma-detail.php?firmaid='.$firmaid.'" class="tooltip_styled tooltip-effect-4">
                    <span class="tooltip-item"></span>
                    <div class="tooltip-content">Detaylı Firma Bilgisi</div>
                </a>
            </div>
        </div>
        <!-- End tool_i -->
        <div class="img_container">
            <a href="#">
                ...
                <div class="short_info">
                    <small>Eklenme Tarihi: '.$cek['firma_ekle_tarih'].'</small>
                    <h3>'.$cek['firma_ismi'].'</h3>
                    <p>Tel : '.$cek['firma_tel'].'</p>
                    <p>E-posta : '.$cek['firma_eposta'].'</p>
                    <p>Adres :'.$cek['firma_adres'].'</p>
                </div>
            </a>
        </div>
    </div>
...
ymaps.ready(function(){
    ...
    while ($cek = $sonuc->fetch_assoc()) {
        ...
        $content = '<div class="marker_info"><div style="width: 290px; height: 140px; background: rgba(1); display: inline-block;"><img src="'.$cek['firma_resim'].'" style="background: black; width: 180px; margin-left: 30px; margin-top: 20px;" alt=""></div><span><h3>'.$cek['firma_ismi'].'</h3><p>'.$cek['firma_turu'].'</p><a href="firma-detail.php?firmaid='.$firmaid.'" class="btn_infobox_detail"></a><a href="' . $url . '" target="_blank" class="btn_infobox_get_directions">Yol Tarifi Al</a><br><a href="tel:'.$cek['firma_tel'].'" class="btn_infobox_phone">'.$cek['firma_tel'].'</a></span></div>';
    ...
    <div id="popupp" class="popupp">
		...
		<p></p>
		<p class="popup-contentt">Sadece üyelerimiz sektör eklemesi yapabilir. Lütfen giriş yapınız.
		</p>
		<p><a href="giris.php" class="buttonr">Giriş yap</a>                   <a href="kayit.php" class="buttonr">Kayıt ol</a></p>
