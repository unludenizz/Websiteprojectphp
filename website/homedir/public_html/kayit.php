...
if(isset($_POST["kaydet"])){
    ...
    if(empty($parola1)){
        $parola_err1 = "Parola boş geçilemez.";
    }
    else if (strlen($parola1) < 5 || strlen($parola1) > 20) {
        $parola_err1 = "Parolanız 5-20 karakter uzunluğunda olmalıdır.";
    } 
    else{
    ...
    if(empty($parola2)){
        $parola_err2 = "Parola tekrar kısmı boş geçilemez.";
    }
    else if (strlen($parola2) < 5 || strlen($parola2) > 20) {
        $parola_err2 = "Parolanız 5-20 karakter uzunluğunda olmalıdır.";
    }
    
    else if($parola1 != $parola2){
        $parola_err2 =" Parolalar eşleşmiyor.";
    }
                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="kayit" selectedPHP>Türkçe</option>
                            <option value="eng/kayit">İngilizce</option>
                            <option value="deu/kayit">Almanca</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="container margin_30">
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="box_login">
                    <strong><i class="icon_lock-open_alt"></i><h3>HESAP OLUŞTUR</h3></strong>
                     <!-- kayıt -->
                    <form action="kayit.php" method="POST">
                        <div class="form-group">
                            ...
                            " id="exampleInputEmail1"  placeholder="Kullanıcı Adı">
                        ...
                        <div class="form-group">
                            ...
                            " id="exampleInputPassword1" placeholder="Şifreni Tekrar yaz" name="parola2">
                            <span class="input-icon"><i class="icon_lock_alt"></i></span>
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                <?php echo $parola_err2;  ?>
                            </div>
                        </div>
                        <a class ="uyelikyazi" href="giris.php" >Üyeliğin Varsa Buraya Tıkla</a>
                        <div id="pass-info" class="clearfix"></div>
                        <button  type="submit" name="kaydet" class="button_login">Yeni Hesap Oluştur</button>
                    </form>
                </div>
            </div>
        </div>
