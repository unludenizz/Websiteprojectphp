     ...
     if ($result->num_rows > 0) {
      ...
      for ($i = 0; $i < 30; $i++) {
       $token .= $chars[mt_rand(0, strlen($chars) - 1)];
        ...
        $Link = "http://www.golhisarim.com.tr/eng/reset.php?email=$email&token=$token";
        ...
        $message = "Password privacy protection sent to your email address.";
                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="forgotpass" selected>English</option>
                            <option value="../forgotpass">Turkish</option>
                            <option value="../deu/forgotpass">German</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    ...
                    <button type="submit" name="submit" class="button_login">SEND</button>
                    </form>
                </div>
            </div>
        </div>
