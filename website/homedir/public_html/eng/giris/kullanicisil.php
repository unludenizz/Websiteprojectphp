...
if($sonuc->num_rows>0){
    ...
    if($baglanti2->query($sql) === true){
        echo "The updated company request has been deleted. ";
    }
    ...
    if($baglanti2->query($sql2) === true){
        echo "The photos have been deleted. ";
    }
    ...
    if($baglanti2->query($sql5) === true){
        echo "Accepted photos have been deleted. ";
    }
