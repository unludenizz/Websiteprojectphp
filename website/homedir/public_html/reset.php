...
WHERE email = '$email'";
    ...
    $url = "https://www.golhisarim.com.tr/giris.php";
    $wait_time = 3;
                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="reset" selected>Türkçe</option>
                            <option value="eng/reset">İngilizce</option>
                            <option value="deu/reset">Almanca</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    ...
                    <button type="submit" name="submit" onclick="openpopuppp()" class="button_login">DEĞİŞTİR</button>
                    </form>
                </div>
            </div>
        </div>
