...
if (isset($_POST["gonder"])) {
    ...
    if (empty($soyisim)) {
        $lastname_err = "Nachname darf nicht leer sein.";
                ...
                <nav class="col--md-8 col-sm-9 col-xs-8">
                    <ul id="primary_nav">
                        ...
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            ...
                            <option value="../../giris/contacts">Türkisch</option>
                        </select>
                        </div></li>
...
<?php } ?>
            ...
            <aside class="col-md-3">
                ...
                <form action="http://maps.google.com/maps" method="get" target="_blank">
                    <div class="form-group">
                        <input type="text" name="saddr" placeholder="Gib deinen Standort an..." class="form-control styled">
                        <input type="hidden" name="daddr" value="Burdur, Gölhisar">
                        <!-- Write here your end point -->
                    </div>
                    <input type="submit" value="Sicht" class="button small nomargin">
                </form>
                <hr class="styled">
            </aside>
            <!--End aside -->
