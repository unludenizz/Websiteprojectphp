                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="giris" selectedPHP>Türkçe</option>
                            <option value="eng/giris">İngilizce</option>
                            <option value="deu/giris">Almanca</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    ...
                    <strong><i class="icon_key_alt"></i><h3>Giriş Yapınız</h3></strong>
                    ...
                    <div class="form-group" style="margin-bottom:5px;">
                        <input type="password" class="form-control" placeholder="Şifre" name="parola" style="margin-bottom:5px;">
                        <span class="input-icon"><i class="icon_lock_alt"></i></span>
                    </div>
                    <p class="small">
                        <a href="forgotpass.php">Şifreni unuttuysan tıkla.</a>
                    </p>
                    <p class="small">
                        <a href="kayit.php">Üyeliğin yoksa tıkla.</a>
                    </p>
                    <button type="submit" name="giris" class="button_login">GİRİŞ YAP</button>
                    </form>
                </div>
            </div>
        </div>
