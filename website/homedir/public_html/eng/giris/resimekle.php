...
$sonuc1 = mysqli_query($baglanti2, $sql3);
    ...
    $message = "The new photo has been successfully added.";
    header("refresh:1;url=#");
    $alert_box = "<div class='alertt'><div class='alertt-box'><span class='closee-btn' onclick='closeAlertt()'>×</span>$message</div></div>";
        
    echo $alert_box;
    
    // 5 saniye sonra sayfayı belirtilen sayfaya yönlendir
    //echo "<script>setTimeout(function() { window.location.href = 'resimekle.php'//; }, 5000);</script>";
}
 else {
        }
        } else {
            
            $message = "Your right to add photos has expired, please delete your photos first.";
                ...
                <div class="col-xs-8">
                  ...
                  <!-- <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="resimekle" selected>English</option>
                            <option value="../../giris/resimekle">Turkish</option>
                            <option value="../../deu/giris/resimekle">German</option>
                        </select>
                    </div>
                </div>-->
            </div>
    ...
    <div class="container margin_30">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    <strong><h3>ADD YOUR COMPANY'S PHOTO</h3></strong>
                     <!-- kayıt -->
                    <form action="resimekle.php?firmaismi=<?php echo $firmaismi?>&kategori=<?php echo $kategori?>" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <br>
                        <input type="file" name="resim" accept="image/*" capture="user" value="" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Please select an image file.')" required>
                        <br>
                        <br>
                        <br>
                        <br>
                        <br>
                        <h4><input type="submit" value="Add Photo"></h4>
                    </form>
                    <h5>Your Remaining Photo Right:<?php echo 10-$resimsayisi;?></h5>
                </div>
            </div>
