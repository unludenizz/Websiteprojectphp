...
$firmaadi = $_POST["firmaadi"];
   ...
   if (empty($firmaadi)) {
        ...
        $firmaadi_err = "Der Firmenname sollte 3-20 Zeichen lang sein.";
    } 
    else if (!preg_match("/^[a-zA-Z0-9_ğüşıöçĞÜŞİÖÇ ]+$/u", $firmaadi)) {
        $firmaadi_err = "Der Firmenname sollte nur aus Buchstaben (a-z), Zahlen (0-9) und Unterstrich (_) bestehen.";
    }
    else{
        $firmaadii = $firmaadi;
    }
...
if (empty($firmasahip)) {
        ...
        $firmasahip_err = "Der Name des Firmeninhabers sollte 3-40 Zeichen lang sein.";
    }
...
{ 
    ...
    if(mysqli_num_rows($kontrolfirmaturu) > 0 && $firma_turuu !== $suankifirmaturu && mysqli_num_rows($kontroltur) > 0) {
        $message = "Schreiben Sie in den Namen dieser Firmenart eine andere Firmenart, deren Firmenname bereits eingetragen ist oder ändern Sie Ihren Firmennamen.";
        $varmiFirmaTuru=1;
    }
    ...
    if ($varmiFirmaİsmi==1) {
        $message .= "- Ein Unternehmen mit diesem Namen ist bereits registriert.\n";
        $message .= "<br>";
    }
    
    if ($varmiFirmaTuru==1) {
        $message .= "- Wählen Sie eine andere bei diesem Firmentyp registrierte Firmentour mit dem Namen einer anderen Firma oder ändern Sie Ihren Firmennamen.";
    }
    if(isset($message)){
    ...
    <div class="container margin_30">
        <div class="row">
            ...
            <div class="bilgilendirme">
                    <strong><h3>ÄNDERN SIE NUR DIE INFORMATIONEN, DIE SIE ÄNDERN WOLLEN.</h3></strong>
                    </div>
                   ...
                   <form action="guncellefirma.php?firmaismi=<?php echo $firmaismi?>&kategori=<?php echo $kategori?>" method="POST">
                       <h5>Name der Firma:</h5>
                        <div class="form-group">
                            ...
                            " id="exampleInputEmail1" value="<?php echo $firmaismi; ?>" placeholder="Name der Firma">
                        ...
                        <div class="form-group">
                            ...
                            " id="exampleInputPassword1" value="<?php echo $cek['firma_adres'];?>" placeholder="Firmenanschrift" name="firmaadres">
                        ...
                        <div class="form-group">
                            ...
                            " id="exampleInputPassword1" value="<?php echo $cek['firma_eposta'];?>" placeholder="E-Mail-Adresse des Unternehmens" name="firmaeposta">
                            <span class="input-icon"><i class="icon_mail_alt"></i></span>
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                <?php echo $firmaeposta_err;  ?>
                            </div>
                        </div>
                        <h5>Ihre Unternehmenskategorie:</h5>
                        <div class="form-group">
                            ...
                            <option value="banka-ve-finans" <?php if($kategori === 'banka-ve-finans') echo 'selected'; ?>>Banken und Finanzen</option>
                              <option value="hizmet-sektoru" <?php if($kategori === 'hizmet-sektoru') echo 'selected'; ?>>Dienstleistungsbranche</option>
                              <option value="egitim" <?php if($kategori === 'egitim') echo 'selected'; ?>>Ausbildung</option>
                              <option value="ev-bahce-ve-dekorasyon" <?php if($kategori === 'ev-bahce-ve-dekorasyon') echo 'selected'; ?>>Haus, Garten und Dekoration</option>
                              <option value="otomotiv" <?php if($kategori === 'otomotiv') echo 'selected'; ?>>Automobil</option>
                              <option value="saglik" <?php if($kategori === 'saglik') echo 'selected'; ?>>Gesundheit</option>
                              <option value="resmi-kurumlar" <?php if($kategori === 'resmi-kurumlar') echo 'selected'; ?>>Regierungsbehörden</option>
                              <option value="yeme-icme" <?php if($kategori === 'yeme-icme') echo 'selected'; ?>>Essen und Trinken</option>
                              <option value="giyim-moda" <?php if($kategori === 'giyim-moda') echo 'selected'; ?>>Kleidung-Mode</option>
                              <option value="iletisim" <?php if($kategori === 'iletisim') echo 'selected'; ?>>Kommunikation</option>
                              <option value="insaat" <?php if($kategori === 'insaat') echo 'selected'; ?>>Gebäude</option>
                              <option value="konaklama-turizm" <?php if($kategori === 'konaklama-turizm') echo 'selected'; ?>>Unterkunft-Tourismus</option>
                            </select>
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                        ...
                        <div class="resimalani">
                            <a href = "resimekle.php?firmaismi=<?php echo $firmaismi?>&kategori=<?php echo $kategori?>"><h5>Klicken Sie hier für Fotooperationen.</h5></a>
                        </div>
                        <div>
                            
                        </div>
                        <div id="pass-info" class="clearfix"></div>
                        <button  type="submit" name="kaydetfirma" class="button_login">Schicken</button>
                    </form>
                </div>
            </div>
