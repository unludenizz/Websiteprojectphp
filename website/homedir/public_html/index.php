            ...
            <div class="row">
                ...
                <nav class="col--md-8 col-sm-9 col-xs-8">
                    <ul id="primary_nav">
                        ...
                        <li id="buy"><a href="#" onclick="openPopupp()" >Sektörünü ekle</a>
                        </li>
                        <li><div class="styled-select">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="index" selected>Türkçe</option>
                            <option value="eng/index">İngilizce</option>
                            <option value="deu/index">Almanca</option>
                        </select>
                        </div></li>
                    </ul>
