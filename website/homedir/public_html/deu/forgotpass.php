     ...
     if ($result->num_rows > 0) {
      ...
      for ($i = 0; $i < 30; $i++) {
       $token .= $chars[mt_rand(0, strlen($chars) - 1)];
        ...
        $Link = "http://www.golhisarim.com.tr/deu/reset.php?email=$email&token=$token";
        ...
        $message = "Emailadresse wurde nicht gefunden.";
         $alert_box = "<div class='alertt'><div class='alertt-box'><span class='closee-btn' onclick='closeAlertt()'>×</span>$message</div></div>";
        echo $alert_box;
                ...
                <div class="col-xs-8">
                    ...
                    <div class="loginceviri">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="forgotpass" selected>Deutsch</option>
                            <option value="../eng/forgotpass">Englisch</option>
                            <option value="../forgotpass">Türkisch</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    ...
                    <div class="form-group">
                        <input type="text" name="email" class=" form-control " placeholder="E-MAİL">
                        <span class="input-icon"><i class="icon_pencil-edit"></i></span>
                    </div>
                   
                    
                   
                    <button type="submit" name="submit" class="button_login">SCHICKEN</button>
                    </form>
                </div>
            </div>
        </div>
