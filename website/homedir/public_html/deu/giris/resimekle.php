...
$sonuc1 = mysqli_query($baglanti2, $sql3);
    ...
    $message = "Das neue Foto wurde erfolgreich hinzugefügt.";
    ...
    //echo "<script>setTimeout(function() { window.location.href = 'resimekle.php'//; }, 5000);</script>";
            ...
            $message = "Ihr Recht zum Hinzufügen von Fotos ist abgelaufen, bitte löschen Sie zuerst Ihre Fotos. ";
            ...
            <div class="col-lg-4 col-lg-offset-2 col-sm-6">
                <div class="box_login">
                    ...
                    <form action="resimekle.php?firmaismi=<?php echo $firmaismi?>&kategori=<?php echo $kategori?>" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <br>
                        <input type="file" name="resim" accept="image/*" capture="user" value="" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Bitte wählen Sie eine Bilddatei aus.')" required>
                        <br>
                        <br>
                        <br>
                        <br>
                    ...
                    <h5>Verbleibende Anzahl von Foto-Uploads:<?php echo 10-$resimsayisi;?></h5>
                </div>
            </div>
