...
window.onload = function() {
      var alertBox = document.querySelector('.alertt-box');
      var alertHeight = alertBox.clientHeight;
...
//html için
function onSelectLanguage(selectElement) {
  let gelendil = selectElement.value;
  let url = gelendil;
...
//php için
function onSelectLanguagePHP(selectElement) {
  let gelendil = selectElement.value;
  let url = gelendil;
...
function openpopuppp() {
			document.getElementById("popuppp").style.display = "flex";
			localStorage.setItem('popupStatus', 'open');
		}

		function closepopuppp() {
			document.getElementById("popuppp").style.display = "none";
			localStorage.setItem('popupStatus', 'close');
		}

		// Sayfa yüklendiğinde popup durumunu kontrol edin
		window.onload = function() {
