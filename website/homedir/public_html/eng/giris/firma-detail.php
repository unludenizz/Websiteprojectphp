...
<body>
                ...
                <nav class="col--md-8 col-sm-9 col-xs-8">
                    <ul id="primary_nav">
                        ...
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="firma-detail" selected>English</option>
                            <option value="../../giris/firma-detail">Turkish</option>
                            <option value="../../deu/giris/firma-detail">German</option>
                        </select>
                        </div></li>
    ...
    <div id="position">
        <div class="container">
            <ul>
                ...
                <li><a href="profile.php#sektörler">Companys</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container margin_60_30">
            ...
            <div class="col-md-9">
                <div class="box_style_general">
                    <div class="indent_title_in">
                        ...
                        <h1></h1>
                        <h4>Company owner :<a href="#"> <?php echo $firma_sahip; ?> </a></h4>
                        <h4>Company Phone Number :<a href="#"> <?php echo $firma_tel; ?> </a></h4>
                        <h4>Company E-Mail :<a href="#"> <?php echo $firma_eposta; ?> </a></h4>
                        <h4>Company address :<a href="#"> <?php echo $firma_adres; ?> </a></h4>
                        <h1></h1>
                        <h4><a href="#">Some Images of the Company :</a></h4>
                        <!-- slider başka  -->
                        <?php
      ...
      echo '<div class="prev-button" onclick="prevSlide()">Back</div>';
      echo '<div class="next-button" onclick="nextSlide()">Forward</div>';
      echo '</div>';
    } else {
      echo 'No photo found for the specified company ID.';
    }
