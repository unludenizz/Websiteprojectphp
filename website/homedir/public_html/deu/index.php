        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col--md-4 col-sm-3 col-xs-4">
                    <div id="logo_home">
                        <h1><a href="index.php" title="Gölhisar Sektör">Mein Golhisar-Sektor</a></h1>
                    </div>
                </div>
                <nav class="col--md-8 col-sm-9 col-xs-8">
                    <ul id="primary_nav">
                        ...
                        <li id="buy"><a href="#" onclick="openPopupp()" >Fügen Sie Ihre Branche hinzu</a>
                        </li>
                        <li><div class="styled-select">
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="../index">Türkisch</option>
                            <option value="../eng/index">Englisch</option>
                            <option value="index"selected>Deutsch</option>
                        </select>
                        </div></li>
                    </ul>
                    ...
                    <div class="main-menu">
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <li><a href="giris.php">Fügen Sie Ihre Branche hinzu</a>
                                </li>
                                <li id="wishlist"><a href="#sektörler">Branchen</a>
                                </li>
                        </ul>
