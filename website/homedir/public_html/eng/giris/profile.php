...
<body>
                ...
                <nav class="col--md-8 col-sm-9 col-xs-8">
                    <ul id="primary_nav">
                        ...
                        <select class="form-control" name="lang" id="languages" onchange="onSelectLanguagePHP(this)">
                            <option value="profile" selected>English</option>
                            <option value="../../giris/profile">Turkish</option>
                            <option value="../../deu/giris/profile">German</option>
                        </select>
                        </div></li>
    ...
    <section class="header-video">
        <div id="hero_video">
            <div id="sub_content_in">
                ...
                <p>
                    Welcome, <?php echo $_SESSION["kullanici_adi"]; ?>
                </p>
    ...
    <script>function sendValue(value) {
